/**
 * @file Renders healthcare professional registration and stores
 * profile metadata after Supabase account creation.
 */
...
const SignUpScreen = () => {
  ...
  /**
   * Creates a Supabase auth user and persists the related HCP profile.
   */
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={() => setModalVisible(true)} style={styles.qualificationButton}>
        <Text style={styles.qualificationButtonText}>
          {qualification ? 'Edit Qualification' : 'Enter Qualification'}
        </Text>
      </TouchableOpacity>
